...
public class BitsLotteryService {

    private final String contractAddress;
    private final Web3j web3j;
    private final BitsLotteryProperties config;

    public BitsLotteryService(String contractAddress, Web3j web3j, BitsLotteryProperties config) {
